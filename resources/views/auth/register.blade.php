                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ine_front" type="file" class="form-control @error('ine_front') is-invalid @enderror" name="ine_front" value="{{ old('ine_front') }}" required autocomplete="celular" autofocus accept="image/jpeg,image/png">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Ine trasera') }}</label>

                            <div class="col-md-6">
                                <input id="ine_back" type="file" class="form-control @error('ine_back') is-invalid @enderror" name="ine_back" value="{{ old('ine_back') }}" required autocomplete="ine_back" autofocus accept="image/jpeg,image/png" >
